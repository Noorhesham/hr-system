...
exports.PlatformModule = PlatformModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [platform_settings_service_1.PlatformSettingsService, limits_service_1.LimitsService],
        exports: [platform_settings_service_1.PlatformSettingsService, limits_service_1.LimitsService],
    })
], PlatformModule);
