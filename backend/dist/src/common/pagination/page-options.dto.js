...
class PageOptionsDto {
    ...
    static _OPENAPI_METADATA_FACTORY() {
        return { order: { required: true, default: "desc", enum: ["asc", "desc"], enum: ['asc', 'desc'] }, orderBy: { required: true, type: () => String, default: "createdAt" }, page: { required: true, type: () => Number, default: 1, minimum: 1 }, limit: { required: true, type: () => Number, default: 10, minimum: 1, maximum: 500 }, search: { required: false, type: () => String } };
    }
}
